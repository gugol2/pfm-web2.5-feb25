import { calculatePublicKeyForEnode } from "./calculatePublicKeyForEnode";

describe("calculatePublicKeyForEnode", () => {
  it("should calculate the correct enode public key from a valid private key", () => {
    ...
    const result = calculatePublicKeyForEnode(privateKeyHex);
  ...
  it("should throw an error for a non hexadecimal private key", () => {
    ...
    expect(() => calculatePublicKeyForEnode(invalidPrivateKeyHex)).toThrow(
